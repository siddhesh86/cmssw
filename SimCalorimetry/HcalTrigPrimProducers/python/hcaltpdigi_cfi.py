...
simHcalTriggerPrimitiveDigis = cms.EDProducer("HcalTrigPrimDigiProducer",
    ...
    weightsQIE11HB  = cms.vdouble(1.0, 1.0), ##hardware algo        
    weightsQIE11HE1 = cms.vdouble(1.0, 1.0), ##hardware algo        
    weightsQIE11HE2 = cms.vdouble(1.0, 1.0), ##hardware algo        
    latency = cms.int32(1),
    ...
    numberOfSamplesQIE11 = cms.int32(2),
    numberOfPresamplesQIE11 = cms.int32(0),
