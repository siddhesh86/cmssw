...
cmsRun test/test_HCAL_OOT_PUS_data.py maxEvt=10000 prtEvt=1000 nVtxMin=50 samples=2 presamps=0 wgtHB=1.0,1.0 wgtHE1=1.0,1.0 wgtHE2=1.0,1.0
## PFA1' scheme
printf '\n\ncmsRun test/test_HCAL_OOT_PUS_data.py maxEvt=10000 prtEvt=1000 nVtxMin=50 samples=2 presamps=1 wgtHB=-0.51,1.0 wgtHE1=-0.49,1.0 wgtHE2=-0.45,1.0\n\n'
cmsRun test/test_HCAL_OOT_PUS_data.py maxEvt=10000 prtEvt=1000 nVtxMin=50 samples=2 presamps=1 wgtHB=-0.51,1.0 wgtHE1=-0.49,1.0 wgtHE2=-0.45,1.0
## PFA2' scheme
printf '\n\ncmsRun test/test_HCAL_OOT_PUS_data.py maxEvt=10000 prtEvt=1000 nVtxMin=50 samples=3 presamps=1 wgtHB=-0.69,1.0,1.0 wgtHE1=-0.70,1.0,1.0 wgtHE2=-1.16,1.0,1.0\n\n'
cmsRun test/test_HCAL_OOT_PUS_data.py maxEvt=10000 prtEvt=1000 nVtxMin=50 samples=3 presamps=1 wgtHB=-0.69,1.0,1.0 wgtHE1=-0.70,1.0,1.0 wgtHE2=-1.16,1.0,1.0
