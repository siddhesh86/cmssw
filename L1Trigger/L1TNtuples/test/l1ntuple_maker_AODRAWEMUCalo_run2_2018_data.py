...
# with command line options: l1Ntuple -s RAW2DIGI --python_filename=l1ntuple_maker_run2_2018_data.py -n 100 --no_output --era=Run2_2018 --data --conditions=110X_dataRun2_v12 --customise=L1Trigger/Configuration/customiseReEmul.L1TReEmulFromRAWsimHcalTP --customise=L1Trigger/L1TNtuples/customiseL1Ntuple.L1NtupleAODRAWEMUCalo --customise=L1Trigger/Configuration/customiseSettings.L1TSettingsToCaloParams_2018_v1_3 --customise_commands=process.HcalTPGCoderULUT.LUTGenerationMode=cms.bool(False) --filein=root://cms-xrd-global.cern.ch//store/data/Run2018D/SingleMuon/RAW-RECO/ZMu-PromptReco-v2/000/321/457/00000/FEB94F25-1AA6-E811-BC22-FA163E177DDE.root
...
print '\n\nProcessing l1ntuple_maker_run2_2018_data.py: maxEvt: %d, prtEvt: %d, nVtsMin: %d, nVtsMax: %d, samples: %d, presamps: %d \n' % (args.maxEvt, args.prtEvt,args.nVtxMin,args.nVtxMax,args.samples,args.presamps)
